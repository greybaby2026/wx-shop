<template>
    <div>
                ...
                <div class="ls-card flex flex-wrap col-stretch" style="min-height: 450px">
                    ...
                    <div class="flex col-bottom" style="width: 100%">
                        <div class="border-top flex col-bottom row-left p-t-24" style="width: 100%; height: 57px">
                            ...
                            >
                                <el-button slot="trigger" size="small" v-if="orderData.admin_order_btn.address_btn"
                                    >修改地址</el-button
                                >
                                <template>
                                    <div>
                                    ...
                                    <div class="flex m-t-24">
                                        <el-form ref="address" :model="address" label-width="80px">
                                            <el-form-item label="收货人" prop="return_address">
                                                <el-input class="ls-input" v-model="address.contact" show-word-limit />
                                            </el-form-item>
                                            <el-form-item label="收货电话" prop="return_address">
        ...
        <section>
            <!-- 物流信息 -->
            <div class="ls-card m-t-24 flex flex-wrap col-stretch" v-if="orderData.delivery_type == 1">
                <div style="width: 100%">
                    <div class="nr weight-500 m-b-20 title">物流信息</div>
                    <div class="flex col-top row-between">
                        <div class="bold">
                            <el-form
                                ref="form"
                                :model="orderData"
                                size="small"
                                inline
                                class="flex-col m-t-24"
                                label-width="120px"
                            >
                                <el-form-item label="收货信息"> </el-form-item>

                                <el-form-item label="收货人">
                                    <div class=" ">{{ expressInfo.contact }}</div>
                                </el-form-item>
                                <el-form-item label="手机号码">
                                    <div class=" ">{{ expressInfo.mobile }}</div>
                                </el-form-item>
                                <el-form-item label="收货地址">
                                    <div class=" ">{{ expressInfo.delivery_address }}</div>
                                </el-form-item>
                            </el-form>
                        </div>
                        <div class="bold" style="">
                            ...
                            >
                                ...
                                <el-form-item label="配送方式">
                                    <!-- <div class=" ">{{ orderData.express_parcel[0].send_type_desc }}</div> -->
                                    <div class=" ">{{ orderData.delivery_type_desc }}</div>
                                </el-form-item>
                            </el-form>
                        </div>
                        <div class="bold" style="">
                            <!-- <div style="width: 120px">买家信息</div> -->
                            <el-form
                                ref="form"
                                :model="orderData"
                                size="small"
                                ...
                                label-width="120px"
                            >
                                <el-form-item label="买家信息"> </el-form-item>
                                <el-form-item label="买家昵称">
                                    <div class=" ">{{ orderData.nickname }} （{{ orderData.user_sn }}）</div>
                                </el-form-item>
                                <el-form-item label="联系电话">
                                    <div class=" ">{{ orderData.mobile }}</div>
                                </el-form-item>
                            </el-form>
                        </div>
                    </div>
            ...
            <div
                ...
                style="height: auto"
                v-if="orderData.delivery_type == 2"
            >
                <div style="width: 100%">
                    <div class="nr weight-500 m-b-20 title">提货信息</div>
                    <div class="flex col-top">
                        <div class="bold" style="flex: 1">
                            ...
                            >
                                ...
                                <el-form-item label="门店名称">
                                    <div class=" ">{{ orderData.selffetch_shop.name }}</div>
                                </el-form-item>
                                <el-form-item label="联系人">
                                    <div class=" ">{{ orderData.selffetch_shop.contact }}</div>
                                </el-form-item>
                                <el-form-item label="联系电话">
                                    <div class=" ">{{ orderData.selffetch_shop.mobile }}</div>
                                </el-form-item>
                                <el-form-item label="门店地址">
                                    <div class=" ">{{ orderData.selffetch_shop.detailed_address }}</div>
                                </el-form-item>
                            </el-form>
                        </div>
                        <div class="bold" style="flex: 1">
                            <el-form
                                ...
                                label-width="120px"
                            >
                                <el-form-item label="配送方式">提货信息</el-form-item>

                                <el-form-item label="配送方式">门店自提</el-form-item>
                                <el-form-item label="提货状态">
                                    {{ orderData.verification_status == 0 ? '待核销' : '已核销' }}</el-form-item
                                >
                                <el-form-item label="核销码">{{ orderData.pickup_code }}</el-form-item>
                                <el-form-item label="自提门店">{{ orderData.selffetch_shop.name }}</el-form-item>
                                <el-form-item label="提货时间">{{ orderData.verification_time || '-' }}</el-form-item>
                            </el-form>
                        </div>
                        <div class="bold" style="flex: 1">
                            <el-form
            ...
            <!-- 虚拟商品 物流信息 -->
            <div class="ls-card m-t-24 flex flex-wrap col-stretch" v-if="orderData.delivery_type == 4">
                <div style="width: 100%">
                    <div class="nr weight-500 m-b-20 title">物流信息</div>
                    <div class="flex col-top">
                        <div class="bold">
                        ...
                        <div class="bold" style="margin-left: 20vw">
                            <el-form
                                ref="form"
                                :model="orderData"
                                size="small"
                            ...
                            >
                                ...
                                <el-form-item label="配送方式"> 虚拟发货</el-form-item>
                                <el-form-item
                                    label="发货内容"
                                    v-if="orderData.delivery_content || orderData.delivery_content1.length"
                                >
                                    <ls-dialog class="inline" title="发货内容" width="20vw">
                                        ...
                                        <div>
                                            <div
                                                ...
                                                v-if="orderData.delivery_content_type == 0"
                                            >
                                                {{ orderData.delivery_content }}
                                            </div>
                                            <div
                                                style="word-break: break-all"
                                                v-if="orderData.delivery_content_type == 1"
                                            >
                                                <div v-for="item in orderData.delivery_content1" :key="item.name">
                                                    <span>{{ item.name }} : </span>
                                                    <span class="m-l-15">{{ item.content }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </ls-dialog>
                                </el-form-item>
                                <el-form-item label="发货时间"> {{ orderData.express_time || '-' }}</el-form-item>
                            </el-form>
                        </div>
                        <div class="bold" style="margin-left: 20vw">
                            <el-form
            ...
            >
                <div style="width: 100%">
                    ...
                    <div v-for="(item, index) in orderData.express_parcel" :key="item.id">
                        <div class="parcel-header" v-if="item.send_type == 1">
                            <span> 包裹{{ index + 1 }} </span>
                            <span class="m-l-44"> {{ item.express_name }}</span>

                            <span class="m-l-44"> 运单号码：{{ item.invoice_no }}</span>
                            <span class="m-l-44"> 发货时间：{{ item.create_time }} </span>
                        </div>
                        <div class="parcel-header" v-if="item.send_type == 2">
                            <span> 无需物流 </span>
                            <span class="m-l-44"> 发货时间：{{ item.create_time }}</span>
                        </div>
                        <div class="p-14 flex flex-wrap">
                            <div
                                v-for="(i, index) in item.order_goods_info"
                                :key="index"
                                class="flex m-b-4 m-r-16"
                                style="width: 30%"
                            >
                                <el-image
                                    :src="i.goods_image"
                                    ...
                                    class="flex-none"
                                ></el-image>
                                <div style="height: 78px; width: 100%" class="flex-col row-around m-l-10">
                                    <div class="line-2">{{ i.goods_name }}</div>
                                    <div class="flex row-between" style="width: 100%">
                                        <div>
                                            {{ i.goods_price }}
                                        </div>
                                        <div>x{{ i.delivery_num }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default class OrderDetail extends Vue {
    ...
    getOrderDeliveryInfo() {
        apiOrderDeliveryInfo({ id: this.id }).then(res => {
            ...
            this.address.contact = res.contact
            this.address.mobile = res.mobile
        })
    }
