                    ...
                    <view class="header">
                        ...
                        >
                            <view class="flex">
                                <image
                                    class="icon-image"
                                    src="/bundle/static/images/icon_presell.png"
                                ></image>
                                <text class="xl m-l-6 bold">预售商品</text>
                            </view>
                        </u-divider>
                    </view>
                        ...
                        >
                            <view class="goods-item flex bg-white">
                                <u-image
                                    ...
                                    height="210rpx"
                                    border-radius="10rpx"
                                    :src="item.show_goods.image"
                                />
                                <view class="goods-info m-l-20">
                                    <view class="goods-name line-2 m-b-20">{{
                                        item.show_goods.name
                                    }}</view>
                                    <text class="sale-info xs br60">
                                        已预定{{ item.sale_nums + item.virtual_sale }}件
                                    </text>
                                    <view class="info-footer flex row-between m-t-5">
                                        <view class="price">
                                            <price
                                                :content="item.show_goods.presell_min_price"
                                                :color="themeColor"
                                                :font-weight="500"
                                                mainSize="34rpx"
                                                minorSize="26rpx"
                                            ...
                                            <price
                                                class="m-l-14"
                                                :content="item.show_goods.sell_min_price"
                                                :line-through="true"
                                                color="#999"
                                                mainSize="26rpx"
                                                minorSize="26rpx"
                                        ...
                                        <button class="br60 white btn" size="sm">立即预定</button>
                                    </view>
                                </view>
                            </view>
                        </router-link>
...
import { apiPresellLists } from '@/api/activity.js'
...
export default {
    ...
    onShareAppMessage() {
        ...
        const share = {
            path: `/bundle/pages/goods_presell/goods_presell?invite_code=${code}`
        }
        return share
    },
    computed: {
