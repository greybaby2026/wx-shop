        ...
        <div class="ls-user__grade ls-card m-t-20">
            ...
            <div class="list-table m-t-16">
                <el-table
                    ...
                    size="mini"
                >
                    <!-- <el-table-column prop="level" label="等级级别" min-width="160px">
						<template slot-scope="scope">
							<div v-if="scope.row.level == 1">{{scope.row.level}}级（默认等级）</div>
							<div v-else>{{scope.row.level}}级</div>
						</template>
					</el-table-column> -->
                    <el-table-column prop="name" label="规则名称" min-width="100px"> </el-table-column>
                    <el-table-column prop="keyword" label="关键词" min-width="100px"> </el-table-column>
                    <el-table-column prop="matching_type_desc" label="匹配方式" min-width="100px"> </el-table-column>
                    ...
                    <el-table-column prop="sort" label="排序" min-width="100px"> </el-table-column>
