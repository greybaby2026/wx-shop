<template>
    <div class="user-withdrawal">
        <div class="ls-card">
            <el-alert class="xxl" title="温馨提示： 1.会员活动余额变动记录。活动余额由营销活动赠送。" type="info" :closable="false" show-icon>
            </el-alert>
...
import { apiAccountLog, apiChangeTypeList, apiActChangeType } from '@/api/finance/finance'
