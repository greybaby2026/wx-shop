<template>
    <div class="user-withdrawal">
        <div class="ls-card">
            <el-alert class="xxl" title="温馨提示： 1.会员账户余额变动记录。" type="info" :closable="false" show-icon>
            </el-alert>
...
import { apiAccountLog, apiChangeTypeList, apiBnwChangeType } from '@/api/finance/finance'
