    ...
    <view :class="themeName">
        ...
        <view class="order-detail">
                ...
                <template v-if="!orderInfo.order_status">
                    ...
                    <view class="order-status-desc" v-if="showCountDown">
                        ...
                        <u-count-down
                            ...
                            :show-days="false"
                            :show-hours="getCountDownSegment(orderInfo.cancel_unpaid_orders_time) >= 3600 ? true : false"
                            :font-size="26"
                            :separator-size="26"
                            color="#FFFFFF"
            ...
            <view class="contain order-bill">
                ...
                <view class="cell order-bill__item" v-if="orderInfo.deduct_amount > 0">
                    <view class="cell-label">活动余额抵扣</view>
                    <view class="cell-content">
                        <price
                ...
                <view class="cell order-bill__item">
                    <view class="cell-content">
                        ...
                        <price
                            :content="orderInfo.order_amount - (orderInfo.deduct_amount || 0)"
                            mainSize="32rpx"
                            minorSize="24rpx"
                            :color="themeColor"
                        />
