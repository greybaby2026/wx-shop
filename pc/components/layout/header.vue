            ...
            <div class="header-con xs">
                <div class="wrapper1180 flex row-between">
                    <div class="flex" style="height: 100%">
                      <div v-if="publicData.shop.name">您好，欢迎来到 {{ publicData.shop.name }}！</div>
                        <template v-if="publicData.article && publicData.article.length">
                            ...
                            <client-only>
                                <swiper ref="headerSwiper" :options="swiperOptions">
                                    <swiper-slide class="swiper-item" v-for="(item, index) in publicData.article"
                                        :key="index">
                                        <nuxt-link class="column" style="height: 100%"
                        ...
                        <ul class="flex flex-1">
                            <li v-if="publicData.my.nickname">
                                <el-popover placement="bottom" trigger="hover">
                                    <div class="user-nav">
                                        <nuxt-link class="lighter xs item" to="/user/user_wallet">我的钱包</nuxt-link>
                                        <nuxt-link class="lighter xs item" to="/user/coupons">
                                            优惠券({{ publicData.coupon_num }})</nuxt-link>
                                        <nuxt-link class="lighter xs item" to="/user/collection">我的收藏</nuxt-link>
                            ...
                            <li id="tel-phone-block" v-if="publicData.mnp_qr_code || publicData.oa_qr_code">
                                ...
                                <div class="float-code flex bg-white">
                                    <div class="column-center bg-white" v-if="publicData.mnp_qr_code">
                                        <img style="width: 100px; height: 100px" :src="publicData.mnp_qr_code" alt="" />
                                        <div class="lighter mt10">官方小程序</div>
                                    </div>
                                    <div class="column-center" style="margin-left: 30px" v-if="publicData.oa_qr_code">
                                        <img style="width: 100px; height: 100px" :src="publicData.oa_qr_code" alt="" />
                    ...
                    <div class="search-wrap flex row-between">
                        ...
                        <div class="flex">
                            <div class="search flex">
                                <input type="text" v-model="name" placeholder="请输入要搜索的商品名称" @keyup.enter="toSearch" />
                                <div class="search-btn bg-primary white flex row-center" @click="toSearch">
                                    搜索
                                </div>
                            </div>
                            <nuxt-link to="/shop_cart" class="cart primary flex row-center">
                              <span class="iconfont icon-cart-Empty"></span> 我的购物车({{ publicData.my.cart }})
                            </nuxt-link>
                        </div>
                    </div>
                </div>
