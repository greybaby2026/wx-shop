...
use app\businessapi\controller\BaseBusinesseController;
...
class InitMiddleware
{
    ...
    public function handle($request, \Closure $next)
    {
        ...
        try {
            ...
            $controller = '\\app\\businessapi\\controller\\' . $controller . 'Controller';
            $controllerClass = invoke($controller);
            if (($controllerClass instanceof BaseBusinesseController) === false) {
