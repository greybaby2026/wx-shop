            ...
            >
                ...
                >
                    <el-radio-group v-model="paymentConfigData.merchant_type">
                        ...
                        <el-radio label="partner_sub_merchant" v-if="paymentConfigData.interface_version == 'v3'"
                            >子商户</el-radio
                        >
                    </el-radio-group>
                    <!-- <span class="desc"
                        >企业付款到零钱：需在微信支付中开通“企业付款到零钱”功能，仅支持微信支付接口 V2
                        商家转账到零钱：需在微信支付中开通“商家转账到零钱”功能，支持微信支付接口 V2、V3</span
                    > -->
                </el-form-item>
                ...
                <el-form-item
                    v-if="paymentConfigData.pay_way == 2"
                    :label="`商户API ${paymentConfigData.interface_version}密钥`"
                    prop="pay_sign_key"
                    label-position="right"
                >
                ...
                <el-form-item
                    v-if="paymentConfigData.pay_way == 2 && paymentConfigData.interface_version == 'v3'"
                    :label="'微信支付公钥'"
                    label-position="right"
                    type="textarea"
                    :rows="4"
                >
                    <el-input
                        v-model="paymentConfigData.wechat_public_cert"
                        class="ls-input"
                        type="textarea"
                        :rows="4"
                    ></el-input>
                    <span class="desc"> 微信支付公钥，前往微信商家平台下载并黏贴至此处 </span>
                </el-form-item>
                <el-form-item
                    v-if="paymentConfigData.pay_way == 2 && paymentConfigData.interface_version == 'v3'"
                    :label="'微信公钥ID'"
                >
                    <el-input v-model="paymentConfigData.wechat_public_serial" class="ls-input"></el-input>
                    <span class="desc">微信支付公钥ID，前往微信商家平台生成并黏贴至此处 </span>
                </el-form-item>
                ...
                >
                    ...
                    <span class="desc">支付宝公钥证书（alipayCertPublicKey）</span>
                </el-form-item>
...
export default class PayMethodEdit extends Vue {
    ...
    rules: any = {
        ...
        ali_public_key: [{ required: true, message: '请输入支付宝公钥', trigger: 'blur' }],
    ...
    onCopy() {
        ...
        createInput.value = this.paymentConfigData.domain
