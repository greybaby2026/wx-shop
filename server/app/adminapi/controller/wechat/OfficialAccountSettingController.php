...
use app\adminapi\logic\wechat\OfficialAccountSettingLogic;
use app\adminapi\validate\wechat\OfficialAccountSettingValidate;
...
class OfficialAccountSettingController extends BaseAdminController
{
    ...
    {
        $result = OfficialAccountSettingLogic::getConfig();
    ...
    public function setConfig()
    {
        ...
        OfficialAccountSettingLogic::setConfig($params);
