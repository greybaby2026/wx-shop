            ...
            >
                ...
                >
                    <div class="info-hd flex">
                        <div v-if="item.condition_type != 3" style="width: 50%">
                            <price-formate
                                :price="item.money"
                                :first-size="38"
                                :second-size="38"
                        ...
                        <div v-if="item.condition_type == 3" style="width: 50%">
                            <span style="font-size: 38px">
                                {{ item.discount_ratio }} </span
                            ><span>折</span>
                        </div>
                        <div class="m-l-8 flex-1" style="width: 50%">
                    ...
                    <!-- <div class="info-time xs">{{ item.effective_time || item.use_time_tips }}</div> -->
                    <div class="info-time xs">{{ item.use_time_text2 }}</div>
                </div>
                <div
                ...
                >
                    <div class="muted xs">
                        {{ item.use_scene || item.goods_tips }}
                    </div>
                    <div v-if="item.tips">
                        <i
                            :class="
