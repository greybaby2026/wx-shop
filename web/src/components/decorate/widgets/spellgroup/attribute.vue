                ...
                <el-form ref="form" label-width="80px" size="small" label-position="left">
                    <attribute-item title="选择拼团商品">
                        ...
                        <el-form-item v-else label-width="0">
                            <activity-select type="team" v-model="content.data" />
                        </el-form-item>
                    </attribute-item>
                    ...
                    <attribute-item title="显示内容">
                        ...
                        <el-form-item label-width="0">
                            <div class="flex">
                                <el-checkbox :true-label="1" :false-label="0" v-model="content.show_group_num"
                                    >参团人数</el-checkbox
                                >
                                <color-select class="m-l-10" v-model="styles.group_num_color" reset-color="#FF2C3C" />
                            </div>
                        </el-form-item>
                    </attribute-item>
                    <attribute-item title="按钮设置" v-if="content.style == 1">
                        <el-form-item label="按钮显示">
