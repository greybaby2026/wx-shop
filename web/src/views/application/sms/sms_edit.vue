    ...
    <div class="sms_edit p-b-60">
        ...
        <div class="ls-card m-t-24">
            <el-form ref="form" label-width="135px">
                ...
                <el-form-item label="APP_KEY" v-if="type == 'ali' || type == 'juhe'" size="mini" required>
                ...
                <el-form-item label="SECRET_KEY" v-if="type == 'ali' || type == 'tencent'" size="mini" required>
...
import { apiSmsGetConfigDetail, apiSmsSet } from '@/api/application/sms'
@Component
