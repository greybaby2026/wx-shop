    ...
    <div class="detail" v-loading="pager.loading">
        <div class="flex row m-b-10">
            <div class="flex">
                ...
                <div class="m-l-10">销售状态</div>
                <el-select v-model="searchData.status" style="width: 180px" class="m-l-10">
        ...
        <el-table ef="table" :data="pager.lists" style="width: 100%" height="370px" size="mini" row-key="id">
                    ...
                    <div class="flex">
                        ...
                        <div class="goods-info m-l-8">
                            ...
                            <div class="flex m-t-5">
                                <div class="m-r-5">
                                    <span class="color-grey">价格：</span>
                                    <span class="color-blue">{{ scope.row.price }}</span>
                                </div>
                                <div>
                                    <span class="color-grey">库存：</span>
                                    <span class="color-blue">{{ scope.row.total_stock }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <el-table-column prop="type" label="商品类型" width="120">
                <template slot-scope="scope">
                    <div>{{ scope.row.type === 1 ? '实物' : '虚拟' }}</div>
                </template>
            </el-table-column>
