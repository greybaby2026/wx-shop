...
return [
    ...
    'marketing' => [
        ...
        //门店结算中心
        'storesettlement'    => [
            'page_path'     => '/store_settlement/lists',
            'view'          => [
                'button_auth'   => ['view'],
                'action_auth'   => ['store_settlement.settlement/lists'],
            ],
            'manage'            => [
                'button_auth'   => ['auth_all'],
                'action_auth'   => [
                    'store_settlement.settlement/generate',         //生成汇总账单
    ...
    'finance'   => [
        ...
        //活动余额记录
        'actlog'  => [
            'page_path'     => '/finance/act_log',
            'view'      => [
                'button_auth'   => ['view'],
                'action_auth'   => ['accountlog/lists','accountlog/getactchangetype'],
            ],
        ],
    ...
    //充值抵扣
    'activitydeduct' => [
        'activitydeductconfig' => [
            'page_path'     => '/activity_deduct/config',
            'view'          => [
                'button_auth'   => ['view'],
                'action_auth'   => ['activity.deduct_activity/getconfig'],
            ],
            'save'          => [
                'button_auth'   => ['auth_all'],
                'action_auth'   => ['activity.deduct_activity/setconfig'],
            ],
        ],
    ],
