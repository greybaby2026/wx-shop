<template>
    <view class="order-logistics u-skeleton">
        <view class="express">
            ...
            <scroll-view scroll-x="true" class="scroll-view m-t-30" v-if="parcel.length > 1">
                <view
                    class="pacel m-l-10"
            ...
            <view class="express-card p-24" v-if="activeParcel != 'wait_goods'">
                ...
                >
                    <u-image
                        ...
                        mode="aspectFill"
                    ></u-image>
                    <view class="flex-col m-l-20 row-around" style="height: 100rpx">
                        <view class="line"> {{ item.goods_name }} </view>
                        <view class="flex row-between">
                            <view class="muted">
                                {{ item.goods_price }}
                            </view>
...
export default {
    ...
    async onLoad() {
        ...
        try {
            if (!options.id) throw new Error('物流异常')
